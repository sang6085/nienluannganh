...
const DashBoard: React.FC = () => {
	...
	const [usedCapacity /*, setUsedCapacity*/] = React.useState(12);
	const [totalCapacity /*, setTotalCapacity*/] = React.useState(15);
	...
	return (
		...
		// 					<Box color="text.disabled">{t('dashboard.choose_new_plan')}</Box>
		// 				</Grid>
